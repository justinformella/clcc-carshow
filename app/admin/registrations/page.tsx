                ...
                >
                  ...
                  <td style={tdStyle}>
                    ...
                    {reg.hide_owner_details && (
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#9e9e9e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: "0.35rem", verticalAlign: "middle", display: "inline" }}>
