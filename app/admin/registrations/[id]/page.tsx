              ...
              <DetailSection title="Game Assets">
                ...
                {vehicleSpec ? (() => {
                    ...
                    <>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
                        ...
                        <div style={{ background: "#f8f8f8", padding: "1rem", borderRadius: "6px", textAlign: "center" }}>
                          ...
                          <div style={{ fontSize: "0.7rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--text-light)", marginTop: "0.2rem" }}>LBS</div>
                        </div>
                        <div style={{ background: "#f8f8f8", padding: "1rem", borderRadius: "6px", textAlign: "center" }}>
                      ...
                      {vehicleSpec.engine_type && (
                        <p style={{ fontSize: "0.85rem", color: "var(--text-light)", textAlign: "center", marginBottom: "1.25rem" }}>
                  ...
                  <p style={{ fontSize: "0.85rem", color: "var(--text-light)", marginBottom: "1rem" }}>
                    No specs enriched — race uses defaults (150 HP / 3,000 lbs)
                  </p>
                )}
